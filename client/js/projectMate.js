...
function renderGroupProjects() {
    ...
    groupProjects.forEach((project) => {
        ...
        card_bottom_right_container.classList.add(
            "card-bottom-right-container"
        );
        ...
        document
            ...
            .addEventListener("click", async (event) => {
                ...
                if (isEditTask) {
                    ...
                    let endDate =
                        document.querySelector('[name="endDate"]').value;
                    let assignee = document.querySelector(
                        '[name="taskAssignee"]'
                    ).value;
                    let taskId = task.id;
...
function renderProjectDetails(project, tasks, users, selectedTask) {
    ...
    `;
        ...
        document.getElementById("close-btn").style.display = "none";
        document.getElementById("projectStatusLable").innerText =
            "Project Status";
...
async function getProjectById(projectId) {
    try {
        ...
        document.getElementById("modalTitle").style.backgroundColor =
            "#48338799";
